  ...
  <div>
    <div className="mx-4 lg:mx-32">
      ...
      <ul className="list-decimal pl-10">
        <li>
          <span className="font-bold">Accommodation and catering.</span>
          {' '}
          This section is responsible for room allocation,
          maintenance of cleanliness in and around the hostels and provision of catering services
          to students and staff of the college. The college has hostels for ladies and gents.
        </li>
        <li>
          <span className="font-bold">Guidance and counselling.</span>
          Facilitate student’s personal, social, emotional, intellectual
          and physical wellbeing. The activities carried out include: - Individual counselling, group
          counselling, open forum sessions, team building and community outreach.
        </li>
        <li>
          <span className="font-bold">Career Services.</span>
          This section offers career counselling to enable students to recognize
          ...
          alumni networking, internship, mentorship services among others
        </li>
        <li>
          <span className="font-bold">Sports, recreation and co-curricular activities.</span>
          Coordination of sports, games and
          ...
          rugby and athletics. The focus is on sport for both recreation and excellence.
        </li>
        <li>
          <span className="font-bold">Clubs and societies.</span>
          Christian union, YCS, Seventh day Adventist, Muslims Students
          ...
          The ultimate goal is to grow people into a deep intimacy with God
        </li>
        <li>
          <span className="font-bold">Registration of student’s organization.</span>
          For better coordination, the college through the

  ...
  return (
    <div className="sticky top-0 bg-white z-10">
      <div className="marquee-container bg-[#6B2D30] md:pt-4">
        <p className="marquee-text text-white font-bold tracking-widest md:text-xl" scrollamount="10" behavior="scroll" direction="left" loop="infinite">August & Dec 2024 intake in progress... Apply now!  ||  January 2024 intake in progress... Apply now!</p>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 ">
          <div className="flex justify-between flex-wrap lg:flex-nowrap items-center border-b-2 border-gray-100 py-6 md:py-2 lg:py-1 md:justify-start md:space-x-10">
            ...
            <div>
              ...
              <a href="/" className="judson leading-2 uppercase font-bold text-[#06294D] md:hidden lg:block lg:text-2xl lg:mr-4 ">
                <span className="">
                  Mwala Technical
                  <br />
                  {' '}
              ...
              <div className="mt-6">
                <nav className="grid gap-y-8">
                  ...
                  >
                    ...
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="flex-shrink-0 h-6 w-6 text-[#6B2D30]"
                      fill="none"
                      viewBox="0 0 24 24"
                      strokeWidth="1.5"
                      stroke="currentColor"
